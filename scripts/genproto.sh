...
# protobuf_directories=$(find . -not -path ./.git/ -not -path ./.idea/ -type d -name "proto")
...
echo "Generating protobuf for api/proto"
mkdir -p api/proto
compile -I$GOPATH/src/github.com/spacemeshos/api/proto -I$googleapis_path --go_out=plugins=grpc:api/proto $GOPATH/src/github.com/spacemeshos/api/proto/spacemesh/*.proto
